...
.data
	...
	instruction8 db 13,10,"Heal will regenerate 1 HP$"
...
Main_Game_Player1:;display prompt
	...
	cmp dh, "3"
	je RPSP_1
	jmp Invalid_Main_Game_Player1
Invalid_Main_Game_Player1:
	mov ah,9
	mov dx,offset invalid2
	int 21h
...
Main_Game_Player2:
	...
	cmp dh, "3"
	je RPSP_2
	jmp Invalid_Main_Game_Player2
Invalid_Main_Game_Player2:
	mov ah,9
	mov dx,offset invalid2
	int 21h
	jmp Main_Game_Player2
